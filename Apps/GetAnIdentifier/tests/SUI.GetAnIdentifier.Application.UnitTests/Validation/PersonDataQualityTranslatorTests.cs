...
namespace SUI.GetAnIdentifier.Application.UnitTests.Validation;
...
public class DataQualityTranslatorTests
{
    ...
    public void Translate_ShouldReturnValid_WhenAllRequiredFieldsAreValid()
    {
        ...
        var (hasMetRequirements, result) = PersonDataQualityTranslator.Translate(spec, validation);
    ...
    public void Translate_ShouldSetInvalidForOtherFields_WhenValidationErrorsExist()
    {
        ...
        var (_, result) = PersonDataQualityTranslator.Translate(spec, validation);
