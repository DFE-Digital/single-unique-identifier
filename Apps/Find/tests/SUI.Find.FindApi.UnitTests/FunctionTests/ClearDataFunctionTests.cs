...
public class ClearDataFunctionTests
{
    ...
    //
    // [Fact]
    // public async Task ClearData_HandlesTransactionErrors()
    // {
    //     // Arrange
    //     _mockConfiguration["StorageRetentionDays"].Returns("1");
    //     _context.CurrentUtcDateTime.Returns(new DateTime(2026, 03, 05));
    //
    //     var innerResponse = Substitute.For<Response>();
    //     innerResponse.IsError.Returns(true);
    //
    //     IReadOnlyList<Response> innerResponses = new []
    //     {
    //
    //     };
    //
    //     Response<IReadOnlyList<Response>> errorResponse = Response.FromValue(innerResponses, Substitute.For<Response>());
    //
    //     _tableClient.SubmitTransactionAsync(
    //         Arg.Any<IEnumerable<TableTransactionAction>>(),
    //         Arg.Any<CancellationToken>()
    //     ).Returns(errorResponse);
    //
    //     // Act
    //     await _function.ClearData(new TimerInfo(), _orchestrationClient, _tableClient, _context, _cancellationToken);
    //
    //     // Assert
    //     _tableClient
    //         .Received(1)
    ...
    //         );
    //
    //     _mockLogger.ReceivedWithAnyArgs(1).LogError(Arg.Any<RequestFailedException?>(),  "Error querying or clearing table. Table server failed the request.");
    //
    //     await _tableClient
    //         .DidNotReceive()
    //         .SubmitTransactionAsync(
    ...
    //         );
    //
    //     await _orchestrationClient
    //         .Received(1)
    //         .PurgeInstanceHistoryAsync(
    //             Arg.Any<DateTime>(),
    //             Arg.Any<DateTime>(),
    //             Arg.Any<IEnumerable<OrchestrationStatus>>()
    //         );
    // }
}
