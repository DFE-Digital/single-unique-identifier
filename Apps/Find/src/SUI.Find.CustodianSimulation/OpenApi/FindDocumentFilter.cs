...
public sealed class FindDocumentFilter : IDocumentFilter
{
    public void Apply(IHttpRequestDataObject req, OpenApiDocument document)
    {
        ...
        document.Tags = new List<OpenApiTag>
        {
            ...
            Tag(
                "LOCAL-AUTHORITY-01",
                "Example Local Authority custodian. GET with standard recordType query.",
                10
            ),
            ...
            Tag(
                "POLICE-01",
                "Example Police custodian. POST, fixed crime-justice record type.",
                13
            ),
            Tag(
                "HOUSING-01",
                "Example Housing custodian. GET with optional recordType path segment.",
                14
            ),
        };
    }
