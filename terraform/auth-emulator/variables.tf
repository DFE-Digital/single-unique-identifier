...
variable "authemulator_app_settings" {
  description = "Additional app settings to apply to the AuthEmulator web app."
  type        = map(string)
  default     = {}
}
...
variable "app_service_plan_sku" {
  description = "SKU name for the shared App Service plan (present to support shared tfvars files; unused by AuthEmulator app)."
  type        = string
  default     = null
}

variable "app_service_plan_os_type" {
  description = "OS type for the App Service plan (present to support shared tfvars files; unused by AuthEmulator app)."
  type        = string
  default     = null
}

variable "app_service_plan_worker_count" {
  description = "Number of workers for the App Service plan (present to support shared tfvars files; unused by AuthEmulator app)."
  type        = number
  default     = null
}
