...
* [Architecture decisions](./Architecture%20decisions/index.md)

### Design

* [Get an Identifier as-built design](./Design/GetAnIdentifier/AsBuilt.md)
* [Polling API Design (proposed discovery design)](./Design/Variants/PollingDiscovery/Polling/Endpoints.md)
