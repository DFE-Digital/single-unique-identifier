...
2. All changes should be based on the main branch.

3. Make your changes, ensuring each commit has a clear and descriptive message summarising the purpose of the change.

4. Push your changes to your branch.

5. Open a pull request against the main branch of our repository.

6. All tests should pass before merging.
