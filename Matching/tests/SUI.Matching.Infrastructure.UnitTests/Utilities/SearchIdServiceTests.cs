...
namespace SUI.Matching.Infrastructure.UnitTests.Utilities;
...
public class SearchIdServiceTests
{
    ...
    public void CreatePersonHash_ReturnsConsistentHash_ForSameInput()
    {
        ...
        var hash1 = _searchIdService.CreatePersonHash(
            person.Given,
            person.Family,
            person.BirthDate.GetValueOrDefault(),
            person.Gender,
    ...
    public void CreatePersonHash_ChangesHash_WhenRelevantFieldChanges()
    {
        ...
        var hash1 = _searchIdService.CreatePersonHash(
            person1.Given,
            person1.Family,
            person1.BirthDate.GetValueOrDefault(),
            person1.Gender,
            person1.AddressPostalCode
        );
        var hash2 = _searchIdService.CreatePersonHash(
            person2.Given,
            person2.Family,
            person2.BirthDate.GetValueOrDefault(),
            person2.Gender,
            person2.AddressPostalCode
        );
    ...
    public void StoreSearchIdInBaggage_StoresHashInActivityBaggage()
    {
        ...
        var baggageValue = Activity
            .Current.Baggage.FirstOrDefault(kv => kv.Key == SearchIdConstants.SearchIdStorageKey)
            .Value;
