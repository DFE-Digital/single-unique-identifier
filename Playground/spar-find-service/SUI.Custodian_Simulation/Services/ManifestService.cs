...
internal static class ManifestService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return await ProblemResponse(req, HttpStatusCode.BadRequest, "Invalid request", "personId is required.");
        }
        ...
        {
            return await ProblemResponse(req, HttpStatusCode.NotFound, "Not found", $"Custodian '{orgId}' is not configured.");
        }
